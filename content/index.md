...
My research interests include system and algorithm design for generative AI (primarily LLMs), formal verification, and now their [[Verge|potential crossover]]. I am also a bit of a programming language nerd.
...
**[SOSP 2025](https://sigops.org/s/conferences/sosp/2025/)** \[[[aegaeon-paper.pdf|PDF]]\] \[[[aegaeon-slides-final.pdf|Slides]]\]

**Automated Verification of an In-Production DNS Authoritative Engine**
_Naiqian Zheng*, Mengqi Liu*, **Yuxing Xiang**, Ennan Zhai, Linjian Song, Dong Li, Feng Han, Nan Wang, Yong Ma, Zhuo Liang, Dennis Cai, Xuanzhe Liu, Xin Jin (*Co-first)_
**[SOSP 2023](https://sosp2023.mpi-sws.org/)** \[[PDF](https://www.zhengnq.com/files/SOSP23-DNSV.pdf)\] \[[Slides](https://www.zhengnq.com/files/SOSP23-DNSV-Slides.pdf)\]
